...
<html lang="en">
<head>
    <title>{{ trans('auth.login-page-title') }}</title>
            ...
            <section class="login_content">
                ...
                <form method="POST" action="{{ route('sentinel.session.store') }}" accept-charset="UTF-8">
                    ...
                    <div class="form-group {{ ($errors->has('email')) ? 'has-error' : '' }}">
                        <input class="form-control" placeholder="{{ trans('auth.field-email') }}" autofocus="autofocus" name="email" type="text"
                    ...
                    <div class="form-group {{ ($errors->has('password')) ? 'has-error' : '' }}">
                        <input class="form-control" placeholder="{{ trans('auth.field-password') }}" name="password" value="" type="password">
                    ...
                    <div class="text-center">
                        ...
                        <a class="btn btn-link" href="{{ route('sentinel.forgot.form') }}">{{ trans('auth.forgot-password') }}</a>
                    </div>
